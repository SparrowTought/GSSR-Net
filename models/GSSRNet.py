...
from .DualMamba import DuaiMamba
from .resnet import resnet34
from einops import rearrange

from models.LCEF import LCFE,Decode
import numpy as np
...
class GSSRNet(nn.Module):


    def __init__(self, input_nc, output_nc, with_pos, normal_init=True,
                 ):
        super(GSSRNet, self).__init__()

        self.backbone = DuaiMamba()
        ...
        self.Short1 = LCFE(384)
        self.Short2 = LCFE(192)
        self.Short3 = LCFE(96)
        self.Short4 = LCFE(64)

        self.decode4 = Decode(192)
        self.decode3 = Decode(96)
        self.decode2 = Decode(64)
    ...
    def forward(self, x1, x2):
        ...
        cross3 = self.Short3(y_c1_2p, x_c1_2p)
        cross2 = self.Short4(y_c1_1p, x_c1_1p)
    ...
    def init_weights(self):
        self.Short1.apply(init_weights)
        self.Short2.apply(init_weights)
        self.Short3.apply(init_weights)
        self.Short4.apply(init_weights)
